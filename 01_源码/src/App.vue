...
const SET_GUIDE = [
  ...
  { id: 'set-data', t: '💾 数据', d: '备份/导入/清空、本地/Gitee/GitHub/WebDAV 互通、导入笔记、出题历史、时政时间范围。', tips: '同步已拆成三个独立按钮：「⬆️ 上传本机备份 / ⬇️ 下载云端最新 / 🔀 智能合并」，不会再一按就覆盖；换设备想保留学习数据用智能合并即可。云同步不传设置、模型、API Key、同步密码和外观偏好，避免覆盖本机已配置内容。' },
        ...
        <details class="guide">
          ...
          <div class="guide-body">
            <ul>
              ...
              <li><b>想换设备接着用？</b> 两端「数据与同步」选同一个方案（Gitee / GitHub / WebDAV），填同一账号后点「🔀 智能合并」即可；也可「⬆️ 上传本机备份」→ 新设备「⬇️ 下载云端最新」。云同步只传学习数据，模型、API Key、同步密码和外观设置不会进入云端。</li>
        ...
        <template v-else>
          ...
          <div class="ob-body">
            ...
            <ul>
              ...
              <li>☁️ 想多端同步：顶部「💾 数据同步」选 Gitee / GitHub / WebDAV，填同一账号后点「🔀 智能合并」（只同步学习数据，设置和 API Key 不上传）。</li>
            </ul>
